    ...
    * **M-step** — fit the parametric Gaussian policy to the weighted samples by
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if self.num_costs != 1:
            raise ValueError(f"CVPO E-step dual solve supports a single cost constraint, got num_costs={self.num_costs}.")
    ...
    def _update_actor_and_alpha(
        ...
        with torch.no_grad():
            ...
            # Evaluate critics on the N*B expanded (state, candidate-action) pairs.
        ...
        for _ in range(self.mstep_iteration_num):
            ...
            # Weighted log-likelihood of the E-step samples under the new Gaussian.
            ...
            # Dual ascent on the KL multipliers: raise alpha when KL exceeds its trust region.
        ...
        # Polyak-average the target actor toward the online actor.
        with torch.no_grad():
